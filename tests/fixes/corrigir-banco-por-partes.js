    ...
    try {
        ...
        await pool.query(`
            ...
            ON CONFLICT (user_id, exchange) DO UPDATE SET 
                ...
                last_validated = NULL
        `, ['JQVNAD0aCqNqPLvo25', 'process.env.API_KEY_HERE', 'JQVNAD0aCqNqPLvo25', 'process.env.API_KEY_HERE']);
        ...
        await pool.query(`
            ...
            ON CONFLICT (user_id, exchange) DO UPDATE SET 
                ...
                validation_status = 'pending',
                last_validated = NULL
        `, ['DxFAJFj3K19e1g5E', 'process.env.API_KEY_HERE', 'DxFAJFj3K19e1g5E', 'process.env.API_KEY_HERE']);
        ...
        await pool.query(`
            ...
            ON CONFLICT (user_id, exchange) DO UPDATE SET 
                ...
                validation_status = 'pending',
                last_validated = NULL
        `, ['2iNeNZQepHJS0lWBkf', 'process.env.API_KEY_HERE', '2iNeNZQepHJS0lWBkf', 'process.env.API_KEY_HERE']);
