...
function validateConfig() {
    const required = ['DATABASE_URL', 'COINSTATS_API_KEY'];
    ...
    if (missing.length > 0) {
        ...
        console.error('COINSTATS_API_KEY="YOUR_API_KEY_HERE"');
        // Não vamos jogar erro em desenvolvimento para permitir testes
