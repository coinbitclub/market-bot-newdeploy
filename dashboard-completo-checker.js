...
const endpoints = [
    ...
    { route: '/api/dashboard/users', method: 'getPerformanceUsuarios' },
    { route: '/api/dashboard/balances', method: 'getSaldosReaisChaves' },
    { route: '/api/dashboard/metrics', method: 'getMetricasOperacionais' },
    { route: '/api/dashboard/system', method: 'getStatusSistema' },
    { route: '/api/dashboard/admin-logs', method: 'getLogsAdministrativos' },
    { route: '/api/dashboard/search', method: 'buscarDados' },
    { route: '/api/dashboard/performance-metrics', method: 'getMetricasPerformance' },
