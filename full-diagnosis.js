...
async function fullDiagnosis() {
    try {
        ...
        for (const user of users.rows) {
            ...
            if (user.binance_api_key_encrypted && user.binance_api_secret_encrypted) {
                ...
                const encryptionKeys = [
                    process.env.ENCRYPTION_KEY || 'CoinBitClubSecretKey32CharsForProd',
        ...
        console.log(`   ENCRYPTION_KEY value: ${process.env.ENCRYPTION_KEY || 'CoinBitClubSecretKey32CharsForProd'}`);
