...
async function testAutomaticMonitoringSystem() {
  ...
  try {
    ...
    const databaseUrl = process.env.DATABASE_URL || 'postgresql://postgres:password@localhost:5432/coinbitclub';
    ...
    const newApiSecret = '1KkVFTExPQKzZwHsXaUKwzGVSCxCRW6izgbn';
